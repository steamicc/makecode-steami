...
declare const enum DAL {
    ...
    REF_TAG_IMAGE = 3,
    REF_TAG_USER = 32,
    // /libraries/codal-stm32-STEAM32_WB55RG/inc/localconf.h
    BOOTLOADER_START_ADDR = 134217728,
    BOOTLOADER_END_ADDR = 134234112,
    APP_START_ADDR = 134250496,
    DEVICE_USB_ENDPOINTS = 6,
    // /libraries/codal-stm32-STEAM32_WB55RG/model/STM32STEAM32_WB55RG.h
    DEVICE_INITIALIZED = 1,
    // /libraries/codal-stm32-STEAM32_WB55RG/model/STM32STEAM32_WB55RG_IO.h
    ID_PIN_PA0 = 100,
    ID_PIN_PA1 = 101,
    ID_PIN_PA2 = 102,
    ID_PIN_PA3 = 103,
    ...
    // /pxtapp/platform.h
    BOOTLOADER_START = 134217728,
    BOOTLOADER_END = 134250496,
