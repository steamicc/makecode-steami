...
declare namespace screen {
    ...
    //% x.min=0 x.max=130
    //% y.min=0 y.max=130 shim=screen::drawPixel
    ...
    //% y0.min=0 y0.max=130
    //% x1.min=0 x1.max=130
    //% y1.min=0 y1.max=130 shim=screen::drawLine
    function drawLine(x0: int32, y0: int32, x1: int32, y1: int32): void;
    ...
    //% blockId="screen_clearScreen" blockGap=8 shim=screen::clearScreen
